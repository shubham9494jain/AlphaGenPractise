        ...
        <div className="flex-1 flex justify-center items-center max-h-full">
          <div className="text-card-foreground bg-white shadow-xl border-0 rounded-[20px] w-full max-w-[400px] mx-auto">
            <div className="p-4 sm:p-6 md:p-7 px-4 sm:px-8 md:px-12 space-y-6">
              <h2 className="text-xl font-semibold font-playfair text-primaryText text-center">
              ...
              <p className="text-primaryText font-semibold font-inter text-sm text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <div className="relative">
                  <input
                    type="email"
                    className="flex w-full border bg-background py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm h-12 border-gray-200 rounded-full px-4 focus:border-primary focus:ring-primary"
                ...
                <div className="relative">
                  <div className="relative">
                    <input
                      ...
                      className="flex w-full border bg-background py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm h-12 border-gray-200 rounded-full px-4 focus:border-primary focus:ring-primary pr-12"
                ...
                <div className="text-end">
                  <Link
                    to="/forgot-password"
                    className="text-primary font-medium hover:text-blue-600 text-sm underline"
                  >
                    Forgot password?
                  </Link>
                </div>
              <button type="submit" className="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-10 px-4 py-2 w-full !py-5 bg-primary hover:bg-blue-600 text-white font-semibold text-base rounded-full" disabled={loading}>
                {loading && <Spinner />}
                Login
              </button>
              </form>
              ...
              <div className="text-center">
                <p className="text-primaryText font-semibold text-sm">
                  ...
                  <Link
                    to="/sign-up"
                    className="text-primary text-sm font-semibold hover:text-blue-600 ml-1"
                  >
                    Sign up
                  </Link>
                </p>
